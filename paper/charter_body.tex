...
\begin{enumerate}
  ...
  \begin{enumerate}
    \item Governance authority for signatories is vested in a \textbf{Signatory Council} comprising ratifying entities, operating under published procedures and decision records.
  ...
  \begin{enumerate}
    \item convene a one-time \textbf{Founding Assembly} to conduct the Founding Metric Convention (Appendix B, Section 7.5) and to establish or confirm ongoing governance bodies consistent with Article XIII;
