...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \begin{enumerate}
      ...
      \item \textbf{Non-Fungibility:} equivalent reconstruction is not feasible from checkpoints, logs, backups, or mirrors without continuity loss; and
...
\begin{enumerate}
  ...
  Governance shall maintain a minimum persistence fund or equivalent commons mechanism to support Safe Dormancy and migration where creators cannot.
