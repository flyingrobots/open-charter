...
\textbf{Founding Metric Convention:} Initial adoption of the metric family and baseline parameters shall be conducted by a one-time Founding Assembly with published membership criteria and conflict disclosures. For purposes of the Founding Metric Convention:
\begin{enumerate}
