# Critique of *The Open Charter* (0.7.3) — GPT‑5.2 (extra-high)
...
- Version metadata now has a single source of truth (`paper/charter_meta.tex`); the current unreleased draft is version `0.7.3`.
